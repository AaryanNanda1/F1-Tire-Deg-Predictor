...
A temporary test workflow also exists at `.github/workflows/weekly-model-retrain-test.yml`. It is scheduled once for Friday, July 3, 2026 at 2:05 PM EDT (`5 18 3 7 *` UTC) and directly forces the same Active Aero retraining script. Remove this file after the test run is verified.
